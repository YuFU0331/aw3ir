...
window.onload = function () {
    app = new Vue({
        ...
        data: {
            api_key:'713432e99d53ab6a94a3ad0efa1bce03',
        ...
        methods: {
            ...
            remove: function (_city) {      
                this.cityList = this.cityList.filter(item => item.name != _city.name);// A compléter dans la suite du TP          
            }, 
            meteo: function (_city) {  
                this.cityWeatherLoading = true;

                // appel AJAX avec fetch
                fetch('http://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=713432e99d53ab6a94a3ad0efa1bce03')
